            ...
            <article>
              ...
              <div className="text-lg text-gray-400">
                ...
                <blockquote className="italic pl-4 border-l-2 border-gray-200 mb-8">
                  Greg Korshak, a journalist for the New York Times, reported
                  that e-commerce audience will reach 380 million worldwide this
                  year, comprising 250 dedicated fans and 215 occasional
                ...
                <p className="mb-8">
                  ...
                  Morbi tristique senectus et netus et, nibh nisl condimentum id
                  venenatis a condimentum vitae sapien.
                </p>
                <h4 className="font-medium text-gray-200 mb-8">
                ...
                <p className="mb-8">
                  ...
                  lacus luctus accumsan tortor posuere. Habitasse platea
                ...
                <p className="mb-8">
                  ...
                  odio tristique senectus et netus et. Nibh nisl condimentum id
                  venenatis:
                </p>
                ...
                <p className="mb-8">
                  Sapien nec sagittis aliquam malesuada orci sagittis eu
                  volutpat odio facilisis mauris sit amet massa, consectetur
                  adipiscing elit duis tristique sollicitudin nibh sit amet
                  commodo, purus viverra accumsan in nisl nisi scelerisque. Vel
                  pharetra vel turpis nunc eget lorem malesuada bibendum arcu
                  vitae elementum curabitur vitae nunc sed velit. Tempus quam
